...
//         exit;
        if(file_exists($controllerPath . ucwords($url[0]).'.php') ){
            ...
            // returning a json errror instead of a page
            header('content-type: application/json');
            $errormsg  = ['error'=>["status"=>404, 'code'=>'API_03',  'message'=>'API method not available' ]];
            echo json_encode($errormsg);
            exit;


            //$this->notfound("Couldn't find matching controller.");
        }
